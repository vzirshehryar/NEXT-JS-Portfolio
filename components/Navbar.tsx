...
const Navbar = () => {
    ...
    return (
        <nav
            ...
            className="navbar_shadow flex justify-between items-center min-w-[300px] w-[75%] sm:w-[560px] lg:w-[900px] fixed left-1/2 transform -translate-x-1/2 z-10 top-9 bg-[#f6f6f695] text-secondary p-1.5 rounded-full px-5 py-2.5 drop-shadow-2xl"
        >
            <div className="">
                <Link href="#HERO">
                    <Image
